...
#pragma warning disable SYSLIB0011, SYSLIB0051 // Type or member is obsolete
    ...
    {
        Assert.Throws<ArgumentNullException>("info", () => new SubXamlParseException(null!, new StreamingContext()));
    }
...
#pragma warning restore SYSLIB0011, SYSLIB0051 // Type or member is obsolete
    ...
    private class SubXamlParseException : XamlParseException
    {
        public SubXamlParseException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
}
