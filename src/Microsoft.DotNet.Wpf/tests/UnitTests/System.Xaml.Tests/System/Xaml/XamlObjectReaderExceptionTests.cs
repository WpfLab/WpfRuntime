...
public class XamlObjectReaderExceptionTests
{
    [Fact]
    public void Ctor_Default()
    {
        var exception = new XamlObjectReaderException();
    ...
    {
        var exception = new XamlObjectReaderException("message");
    ...
    {
        var exception = new XamlObjectReaderException(message, innerException);
...
#pragma warning disable SYSLIB0011, SYSLIB0051 // Type or member is obsolete
    ...
    {
        Assert.Throws<ArgumentNullException>("info", () => new SubXamlObjectReaderException(null!, new StreamingContext()));
    }
...
#pragma warning restore SYSLIB0011, SYSLIB0051 // Type or member is obsolete
    ...
    private class SubXamlObjectReaderException : XamlObjectReaderException
    {
        public SubXamlObjectReaderException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
}
