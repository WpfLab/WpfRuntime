...
public class PointConverterTests
{
    ...
    [Theory]
    [MemberData(nameof(PointTests.ToString_TestData), MemberType = typeof(PointTests))]
    public void ConvertTo_InvokePointToString_ReturnsExpected(Point matrix, string expected)
    {
        var converter = new PointConverter();
    ...
    [Theory]
    [MemberData(nameof(PointTests.ToString_IFormatProviderCustom_TestData), MemberType = typeof(PointTests))]
    public void ConvertTo_InvokePointToStringCustomCulture_ReturnsExpected(Point matrix, string numberDecimalSeparator, string expected)
    {
    ...
    [InlineData(1, "1")]
    public void ConvertTo_InvokeNotPointToString_ReturnsExpected(object? value, string expected)
    {
        var converter = new PointConverter();
    ...
    public static IEnumerable<object?[]> ConvertTo_CantConvert_TestData()
    {
        ...
        yield return new object?[] { new Point(), typeof(object) };
        
        yield return new object?[] { null, typeof(Point) };
        yield return new object?[] { string.Empty, typeof(Point) };
        yield return new object?[] { "value", typeof(Point) };
        yield return new object?[] { new object(), typeof(Point) };
        yield return new object?[] { new Point(), typeof(Point) };
    }
    ...
    public void ConvertTo_NullDestinationType_ThrowsArgumentNullException(object value)
    {
        ...
        Assert.Throws<ArgumentNullException>("destinationType", () => converter.ConvertTo(null, null, new Point(), null!));
        Assert.Throws<ArgumentNullException>("destinationType", () => converter.ConvertTo(new CustomTypeDescriptorContext(), CultureInfo.InvariantCulture, new Point(), null!));
    }
    ...
    [Theory]
    [MemberData(nameof(PointTests.Parse_TestData), MemberType = typeof(PointTests))]
    public void ConvertFrom_InvokeStringValue_ReturnsExpected(object value, Point expected)
    {
        var converter = new PointConverter();
    ...
    [Theory]
    [MemberData(nameof(PointTests.Parse_InvalidSource_TestData), MemberType = typeof(PointTests))]
    ...
    [Theory]
    [MemberData(nameof(PointTests.Parse_NotDouble_TestData), MemberType = typeof(PointTests))]
