...
public class RectValueSerializerTests
{
    public static IEnumerable<object?[]> CanConvertToString_TestData()
    {
        ...
        yield return new object?[] { new Rect(), true };
    }
    ...
    public void ConvertToString_Invoke_ReturnsExpected(Rect matrix, string expected)
    {
        var serializer = new RectValueSerializer();
    ...
    public void ConvertFromString_Invoke_ReturnsExpected(string value, Rect expected)
    {
        var serializer = new RectValueSerializer();
