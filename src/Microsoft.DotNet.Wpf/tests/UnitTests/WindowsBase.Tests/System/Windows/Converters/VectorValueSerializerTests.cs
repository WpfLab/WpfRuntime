...
public class VectorValueSerializerTests
{
    public static IEnumerable<object?[]> CanConvertToString_TestData()
    {
        ...
        yield return new object?[] { new Vector(), true };
    }
    ...
    public void ConvertToString_Invoke_ReturnsExpected(Vector matrix, string expected)
    {
        var serializer = new VectorValueSerializer();
    ...
    public void ConvertFromString_Invoke_ReturnsExpected(string value, Vector expected)
    {
        var serializer = new VectorValueSerializer();
