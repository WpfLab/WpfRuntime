...
public class PointValueSerializerTests
{
    public static IEnumerable<object?[]> CanConvertToString_TestData()
    {
        ...
        yield return new object?[] { new Point(), true };
    }
    ...
    public void ConvertToString_Invoke_ReturnsExpected(Point matrix, string expected)
    {
        var serializer = new PointValueSerializer();
    ...
    public void ConvertFromString_Invoke_ReturnsExpected(string value, Point expected)
    {
        var serializer = new PointValueSerializer();
