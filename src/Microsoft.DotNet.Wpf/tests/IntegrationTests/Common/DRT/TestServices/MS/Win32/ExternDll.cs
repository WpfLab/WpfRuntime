...
namespace MS.Win32
{
    internal static class ExternDll
    {
        ...
        public const string Penimc = "PenIMC" + PENIMC_SUFFIX + ".dll";
        ...
        public const string PresentationHostDll = "PresentationHost" + SUFFIX + ".dll";
        public const string PresentationNativeDll = "PresentationNative" + SUFFIX + ".dll";
        ...
        public const string WpfGfx = "WpfGfx" + SUFFIX + ".dll";
